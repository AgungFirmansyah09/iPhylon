...
// =========================================
    ...
    if(mysqli_num_rows($cekPacking) == 0){
        ...
        $status = 'error';
        $message = 'QR BELUM SCAN OUT PACKING';
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Scan In SM</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="card card-primary">
          ...
          <div class="card-body">
            <div class="form">
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <label for="inputText" class="col-sm-6 col-form-label">SCAN IN SUPERMARKET</label>
                      <div class="col-sm-12">
              ...
              <button type="submit" name="inSupermarket" hidden></button> 
            </form>
            </div>
          </div>
